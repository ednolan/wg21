...
# srefs.md (stable-reference link defs) is concatenated as a second input;
# source stays first so its front matter wins.
set(_args "${SRC}")
if(EXISTS "${DATA_DIR}/srefs.md")
  list(APPEND _args "${DATA_DIR}/srefs.md")
endif()
list(APPEND _args
  -o "${OUT}"
  "--data-dir=${DATA_DIR}"
