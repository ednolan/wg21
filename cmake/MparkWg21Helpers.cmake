...
set(_srefs_md "${MparkWg21_STAGED_DATA_DIR}/srefs.md")
...
add_custom_target(wg21_data DEPENDS "${_sentinel}" "${_csl}" "${_srefs}" "${_srefs_md}")
...
function(wg21_add_paper name)
  ...
  get_filename_component(_venv_bin "${Python3_EXECUTABLE}" DIRECTORY)
  ...
  foreach(fmt IN LISTS ARG_FORMATS)
    ...
    add_custom_command(
      ...
      DEPENDS "${ARG_SOURCE}"
              "${Pandoc_EXECUTABLE}"
              "${_data}/metadata.yaml"
              "${_data}/csl.json" "${_data}/srefs.json" "${_data}/srefs.md"
